...
public class UsersTests {
    ...
    public void setUp() throws Exception {
        Users users = new Users("kimilguk","김","일국","kimilguk@test.com");
        users.setId(1L);
    ...
    public void deserializejson() throws Exception {
        ...
        assertAll(
                () ->  assertThat(this.usersJacksonTester.parse(content))
                        .isNotEqualTo(new Users("kimilguk","김","일국","kimilguk@test.com")),
    ...
    public void serializeJson() throws Exception {
        ...
        assertJsonPropertyEquals("@.email", "kimilguk@test.com");
    }
